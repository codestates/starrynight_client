        ...
        {this.props.isHamburgerOn ?
          ...
          <div className="menuList_After_Login">
            ...
            <div className="nav_link">
              {/* 로그인 경우 */}
              <div className="list" onClick={this.props.galleryClick}>
                갤러리
              </div>
              {/* <Gallery
                isGalleryModalOpen={this.state.isGalleryModalOpen}
              ...
              <div className="list" onClick={this.props.favoritesClick}>
                즐겨찾기
              </div>
              {/* <Favorites isFavoritesModalOpen={this.state.isFavoritesModalOpen} handleFavoritesModal={this.handleFavoritesModal} /> */}


              <div className="list" onClick={this.props.mypageClick}>
                마이페이지
              </div>
