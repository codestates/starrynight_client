...
function Button({ children, size, color, outline, fullWidth, middleWidth, smallWidth, middleWidth_SignIn_btn, onClick }) {
  return (
    <button
      className={classNames("Button", size, color, { outline, fullWidth, middleWidth, smallWidth, middleWidth_SignIn_btn })}
      onClick={onClick}
    >
      {children}
    </button>
